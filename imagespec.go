...
func newImageSpec(i unsafe.Pointer) *ImageSpec {
	holder := &i
	spec := &ImageSpec{ptr: holder}
	runtime.AddCleanup(spec, cleanupImageSpec, holder)
	return spec
}

// newImageSpecBorrowed creates an ImageSpec that does not own its memory
// (no cleanup registered, used for references returned from C that we don't own)
func newImageSpecBorrowed(i unsafe.Pointer) *ImageSpec {
	// Use a non-nil holder but don't register cleanup
	holder := &i
	return &ImageSpec{ptr: holder}
}

func cleanupImageSpec(ptr *unsafe.Pointer) {
...
func (s *ImageSpec) p() unsafe.Pointer {
	if s.ptr == nil {
		return nil
	}
...
func (s *ImageSpec) ChannelBytesChan(chanNum int, native bool) int {
	ret := int(C.ImageSpec_channel_bytes_chan(s.p(), C.int(chanNum), C.bool(native)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) PixelBytes(native bool) int {
	ret := int(C.ImageSpec_pixel_bytes(s.p(), C.bool(native)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) PixelBytesChans(chanBegin, chanEnd int, native bool) int {
	ret := int(C.ImageSpec_pixel_bytes_chans(s.p(), C.int(chanBegin), C.int(chanEnd), C.bool(native)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) ScanlineBytes(native bool) int {
	ret := int(C.ImageSpec_scanline_bytes(s.p(), C.bool(native)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) TileBytes(native bool) int {
	ret := int(C.ImageSpec_tile_bytes(s.p(), C.bool(native)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) ImagePixels() int {
	ret := int(C.ImageSpec_image_pixels(s.p()))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) ImageBytes(native bool) int {
	ret := int(C.ImageSpec_image_bytes(s.p(), C.bool(native)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) SizeSafe() bool {
	ret := bool(C.ImageSpec_size_safe(s.p()))
	runtime.KeepAlive(s)
	return ret
}

func (s *ImageSpec) ChannelFormat(chanNum int) TypeDesc {
	ret := (TypeDesc)(C.ImageSpec_channelformat(s.p(), C.int(chanNum)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) SetX(val int) {
	C.ImageSpec_set_x(s.p(), C.int(val))
	runtime.KeepAlive(s)
}

func (s *ImageSpec) Y() int {
	ret := int(C.ImageSpec_y(s.p()))
	runtime.KeepAlive(s)
	return ret
}

func (s *ImageSpec) SetY(val int) {
	C.ImageSpec_set_y(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetZ(val int) {
	C.ImageSpec_set_z(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetWidth(val int) {
	C.ImageSpec_set_width(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetHeight(val int) {
	C.ImageSpec_set_height(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetDepth(val int) {
	C.ImageSpec_set_depth(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetFullX(val int) {
	C.ImageSpec_set_full_x(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetFullY(val int) {
	C.ImageSpec_set_full_y(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetFullZ(val int) {
	C.ImageSpec_set_full_z(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetFullWidth(val int) {
	C.ImageSpec_set_full_width(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetFullHeight(val int) {
	C.ImageSpec_set_full_height(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetFullDepth(val int) {
	C.ImageSpec_set_full_depth(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetTileWidth(val int) {
	C.ImageSpec_set_tile_width(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetTileHeight(val int) {
	C.ImageSpec_set_tile_height(s.p(), C.int(val))
	runtime.KeepAlive(s)
}

func (s *ImageSpec) TileDepth() int {
	ret := int(C.ImageSpec_tile_depth(s.p()))
	runtime.KeepAlive(s)
	return ret
}

func (s *ImageSpec) SetTileDepth(val int) {
	C.ImageSpec_set_tile_depth(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetNumChannels(val int) {
	C.ImageSpec_set_nchannels(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) ChannelFormats() []TypeDesc {
	...
	C.ImageSpec_channelformats(s.p(), formats_ptr)
	runtime.KeepAlive(s)
	return formats
}
...
func (s *ImageSpec) SetChannelFormats(formats []TypeDesc) {
	formats_ptr := (*C.TypeDesc)(unsafe.Pointer(&formats[0]))
	C.ImageSpec_set_channelformats(s.p(), formats_ptr)
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) ChannelNames() []string {
	...
	C.ImageSpec_channelnames(s.p(), c_names_ptr)
...
func (s *ImageSpec) SetChannelNames(names []string) {
	...
	c_names_ptr := (**C.char)(unsafe.Pointer(&c_names[0]))
	C.ImageSpec_set_channelnames(s.p(), c_names_ptr)
	for i, _ := range names {
...
func (s *ImageSpec) SetAlphaChannel(val int) {
	C.ImageSpec_set_alpha_channel(s.p(), C.int(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetDeep(val bool) {
	C.ImageSpec_set_deep(s.p(), C.bool(val))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) SetAttribute(name string, val interface{}) error {
	...
	case string:
		...
		C.ImageSpec_attribute_char(s.p(), c_str, c_val)
	case float32:
		C.ImageSpec_attribute_float(s.p(), c_str, C.float(t))
	case int:
		C.ImageSpec_attribute_int(s.p(), c_str, C.int(t))
	default:
...
func (s *ImageSpec) AttributeString(name string, defaultVal ...string) string {
	...
	ret := C.GoString(C.ImageSpec_get_string_attribute(s.p(), c_str, c_val))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) AttributeFloat(name string, defaultVal ...float32) float32 {
	...
	c_str := C.CString(name)
	defer C.free(unsafe.Pointer(c_str))
	ret := float32(C.ImageSpec_get_float_attribute(s.p(), c_str, C.float(defVal)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) AttributeInt(name string, defaultVal ...int) int {
	...
	c_str := C.CString(name)
	defer C.free(unsafe.Pointer(c_str))
	ret := int(C.ImageSpec_get_int_attribute(s.p(), c_str, C.int(defVal)))
	runtime.KeepAlive(s)
	return ret
}
...
func (s *ImageSpec) EraseAttribute(name string, caseSensitive bool) {
	...
	C.ImageSpec_erase_attribute(s.p(), c_str, C.TYPE_UNKNOWN, C.bool(caseSensitive))
	runtime.KeepAlive(s)
}
...
func (s *ImageSpec) EraseAttributeType(name string, searchType TypeDesc, caseSensitive bool) {
	...
	C.ImageSpec_erase_attribute(s.p(), c_str, C.TypeDesc(searchType), C.bool(caseSensitive))
	runtime.KeepAlive(s)
}
